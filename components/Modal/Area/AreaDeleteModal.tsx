...
import { AreaDeleteModalProps } from '../../../services/types/Types';

const AreaDeleteModal = ({ item, showDeleteModal, handleCloseDeleteModal }: AreaDeleteModalProps) => {
  return (
    <Center>
      <Modal isOpen={showDeleteModal} onClose={handleCloseDeleteModal}>
        <Modal.Content maxWidth="400px">
          <Modal.CloseButton />
          <Modal.Header>Deletar Área</Modal.Header>
          <Modal.Body>
